...
<%
	    		...
	    		try {	
	    				...
	    				if(rs.next()) {
		    				...
		    				out.print("<div id=\"subject\"><span>主题:"+subject+"</span></div>");
			    			out.print("<div id=\"sendUser\"><span>发件人:</span><span>"+sendUser+"</span></div>");
			    			out.print("<div id=\"reciveUser\"><span>收件人:</span><span>"+User+"</span></div>");
