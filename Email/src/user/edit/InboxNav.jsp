        ...
        <ul>
            ...
            <%
	    		...
	    		try {	
	    				...
	    				String sql = "select * from mail where reciveUser ='"+User+"'";
	    				...
	    				if(!rs.next()) {
	    					...
	    					out.print("<li><input type=\"checkbox\" id=\""+id1+"\"/><label for=\""+id1+"\"><a href=\"InboxContent.jsp?id="+id1+"\" target=\"right\">"+sendUser1+"<br><span id=\"item\">"+subject1+""
	    					...
	    					while(rs.next()) {		
		    					...
		    					out.print("<li><input type=\"checkbox\" id=\""+id+"\"/><label for=\""+id+"\"><a href=\"InboxContent.jsp?id="+id+"\" target=\"right\">"+sendUser+"<br><span id=\"item\">"+subject+""
